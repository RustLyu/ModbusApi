...
static int compute_data_length_after_meta(int headLength, int8_t *msg, MsgDirection msg_type)
{
...
static int check_confirmation(int headLength, uint8_t *req, int8_t *rsp, int rsp_length)
{
	int rc;
